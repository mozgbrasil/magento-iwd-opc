...
$ji(document).ready(function () {
    if ($ji('#config_edit_form .section-config #opc_opc_store_credit, #config_edit_form .section-config #opc_gift_cards_settings,#config_edit_form .section-config #opc_iwd_recurringpayments').length) {
        $ji('#config_edit_form .section-config #opc_opc_store_credit, #config_edit_form .section-config #opc_gift_cards_settings,#config_edit_form .section-config #opc_iwd_recurringpayments').each(function () {
    ...
    if($ji('#config_edit_form .section-config #carriers_iwdstorepickup')){
        $ji('#config_edit_form .section-config #carriers_iwdstorepickup')
            .append('<span class="iwd_free_opc_locked_button"><i class="fa fa-lock" aria-hidden="true"></i>Unlock Pro</span>');
    }
    $ji('body').append(
